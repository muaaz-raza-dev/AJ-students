...
const LoginFormFields = () => {
    const {register,formState:{errors}} =useFormContext<Ilogin>()
  return (
        <div className="grid w-full items-center gap-4">
          <div className="flex gap-x-1 overflow-hidden !rounded-lg glassEffect px-2 py-4  items-center w-full ">
            ...
            {
                errors.GRNO && <p className="text-red-500 text-xs">{errors.GRNO.message}</p>
            }

          <div className="flex gap-x-1 overflow-hidden !rounded-lg glassEffect px-2 py-4  items-center w-full ">
            <div className="rounded-full center p-2 bg-white">
              <FaLock className="text-primary-foreground" size={28} />
            </div>
            <input
